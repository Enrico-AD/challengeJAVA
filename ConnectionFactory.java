...
public class ConnectionFactory {
    ...
    public ConnectionFactory(Connection conexao, String url, String user, String pass, String driver) {
    ...
    public static ConnectionFactory getInstance() {
        ...
        try {
            ...
            if (instance == null) {
                instance = new ConnectionFactory(null, url, user, pass, driver);
            }
            return instance;
    ...
    public Connection getConexao() {
        try {
            ...
            this.conexao = DriverManager.getConnection(this.url, this.user, this.pass);
